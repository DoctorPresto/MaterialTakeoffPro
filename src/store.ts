...
export const useStore = create<AppState>()(
    persist(
        (set, get) => ({
            ...
            buildingData: {
                icfFoundation: false, foundationPerimeterId: null, foundationAreaId: null, hasGarage: false, garageShapeId: null, roofFlatArea: 0, numPlanes: 0, numPeaks: 0, valleyLength: 0
            },
            scale: 1,
            pageScales: {},
            isScaleLocked: false,
            ...
            createEstimate: () => set({
                ...
                projectInfo: {projectName: "New Project", customerName: "", notes: "", files: []},
                buildingData: { icfFoundation: false, foundationPerimeterId: null, foundationAreaId: null, hasGarage: false, garageShapeId: null, roofFlatArea: 0, numPlanes: 0, numPeaks: 0, valleyLength: 0 },
            ...
            setWizardTool: (tag) => set({ activeWizardTool: tag, activeTool: tag ? (tag.includes('shape') || tag.includes('plane') || tag.includes('area') || tag.includes('foundation') ? 'shape' : 'line') : 'select' }),
            ...
            addMeasurement: (type, points, name, tags = []) => {
                ...
                const newMeasurement: Measurement = { id: uuidv4(), name: uniqueName, type, points, pageIndex: activePageIndex, tags: finalTags };
